...
describe('onTTFB()', async function() {
  ...
  describe('attribution', function() {
    ...
    it('reports after a bfcache restore', async function() {
      ...
      assert.strictEqual(ttfb2.attribution.waitingTime, 0);
      assert.strictEqual(ttfb2.attribution.dnsTime, 0);
      assert.strictEqual(ttfb2.attribution.connectionTime, 0);
      assert.strictEqual(ttfb2.attribution.requestTime, 0);
    });
  });
});
